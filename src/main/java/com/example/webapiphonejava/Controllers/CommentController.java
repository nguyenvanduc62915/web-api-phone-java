...
public class CommentController {
    ...
    public ResponseEntity<BaseResponse<CommentDTO>> addComment(
        ...
        BaseResponse<CommentDTO> baseResponse = commentService.addComment(commentDTO, productId);
        return new ResponseEntity<>(baseResponse, HttpStatus.valueOf(baseResponse.getCode()));
    }
    ...
    public ResponseEntity<BaseResponse<CommentDTO>> updateCommentById(
        ...
        BaseResponse<CommentDTO> baseResponse = commentService.updateCommentById(commentDTO, commentId, productId);
        return new ResponseEntity<>(baseResponse, HttpStatus.valueOf(baseResponse.getCode()));
    }
